...
class ForumAdapterTest {
    ...
    fun displayQuestionTest() {
        ...
        onView(withText(DatabaseManager.db.getQuestionById("question3").get()?.questionId))
        ...
        onView(withText(DatabaseManager.db.getQuestionById("question2").get()?.questionId))
            .check(matches(isDisplayed()))
        ...
        onView(withText(DatabaseManager.db.getQuestionById("question1").get()?.questionId))
            .check(matches(isDisplayed()))
    }
