...
class ForumAdapterTest {
    ...
    fun displayQuestionTest() {
        ...
        onView(withText(DatabaseManager.db.getQuestionById("Very long question").get()?.questionTitle))
        ...
        onView(withText(DatabaseManager.db.getQuestionById("About Scrum master2").get()?.questionTitle))
            .check(matches(isDisplayed()))
        ...
        onView(withText(DatabaseManager.db.getQuestionById("About ci").get()?.questionTitle))
            .check(matches(isDisplayed()))
    }
