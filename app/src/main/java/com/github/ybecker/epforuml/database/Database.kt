...
abstract class Database {
     ...
     */
    abstract fun addQuestion(userId: String, courseId: String, isAnonymous:Boolean, questionTitle: String, questionText: String?,  image_uri: String): CompletableFuture<Question>
