...
class Model {
    ...
    data class Question(val questionId: String, val courseId: String, val userId: String, val questionTitle: String,, val questionText: String, val imageURI : String, var answers: List<Answer>){
