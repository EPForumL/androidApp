...
import com.github.ybecker.epforuml.util.MainActivity.Companion.context
import androidx.swiperefreshlayout.widget.SwipeRefreshLayout
import com.github.ybecker.epforuml.basicEntities.answers.AnswerAdapter
import com.github.ybecker.epforuml.util.MainActivity
import com.github.ybecker.epforuml.R
import com.github.ybecker.epforuml.basicEntities.answers.SavedAnswerAdapter
    ...
    private fun endorsementSetup() {
        db.getQuestionFollowers(questionId).thenAccept {
            ...
            if(notificationActive){
                ...
                notificationButton.setColorFilter(ContextCompat.getColor(context,
                    R.color.light_gray
